...
assert all(molecule_collide(Atom('H', position=cell.T.dot(pos)), atoms, tolerance=0.2) == False for pos in false_test_positions)
assert all(molecule_collide(Atom('H', position=cell.T.dot(pos)), atoms, tolerance=0.2) == True  for pos in true_test_positions)
